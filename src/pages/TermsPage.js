    ...
    <div className="terms-page">
      ...
      <div className="terms-section">
        ...
        <p className="terms-section-content">
          ...
          nulla vel mi eleifend bibendum. Sed euismod metus vel neque pulvinar,
          ac venenatis metus tincidunt. Donec non erat et velit blandit
          tincidunt. Nullam ac ex sed diam cursus consectetur. Sed vel mauris et
          turpis hendrerit rhoncus.
        </p>
      </div>
