...
export default function Header() {
  ...
  const getButtonClass = (buttonPath) => path === buttonPath ? 'header-button-selected' : 'header-button-navbar';
  ...
  return (
    <nav className="header">
      <div className="header-container">
        <Link to="/" className="header-title">Dreamify</Link>
        <div className="header-nav-links-container">
          {/* Render different navigation links based on authentication state */}
          {!isAuthenticated ? (
            <>
              <Link to="/" className="header-button-navbar header-text-navbar">Home</Link>
              <Link to="/login" className="header-button-navbar header-text-navbar">Log In</Link>
              <Link to="/signup" className="header-button-get-started header-text-white">Get Started</Link>
            </>
          ) : (
            <>
              <Link to="/" className={`${getButtonClass("/")} header-text-navbar`}>Home</Link>
              <Link to="/newstory" className={`${getButtonClass("/newstory")} header-text-navbar`}>New Story</Link>
