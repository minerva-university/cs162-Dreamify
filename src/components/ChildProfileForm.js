          ...
          <div className="vis-feature-container" key={eyeColor.name}>
            <img
              ...
              className={`vis-feature ${
                formData.eyeColor === eyeColor.name ? "selected" : ""
              }`}
        ...
        {hairType.map((hair) => (
          <div className="vis-feature-container" key={hair.name}>
            <img
              ...
              alt={hair.name}
              className={`vis-feature ${
                formData.hairType === hair.name ? "selected" : ""
              }`}
            ...
            {hairColor.map((color) => (
              <div className="vis-feature-container" key={color.name}>
                <img
                  ...
                  alt={color.name}
                  className={`vis-feature ${
                    formData.hairColor === color.name ? "selected" : ""
                  }`}
        ...
        {races.map((race) => (
          <div className="vis-feature-container" key={race.name}>
            <img
              ...
              alt={race.name}
              className={`vis-feature ${
                formData.race === race.name ? "selected" : ""
              }`}
